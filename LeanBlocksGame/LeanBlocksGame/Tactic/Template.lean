...
namespace LeanBlocksGame.Tactic
...
where filterArgs (args : List Syntax) : List Syntax :=
  match args with
    ...
    | Syntax.node info `LeanBlocksGame.Tactic.Hole _ :: r =>
    ...
    | Syntax.node _ `LeanBlocksGame.Tactic.Hint _ :: _ :: r
    | Syntax.node _ `LeanBlocksGame.Tactic.Branch _ :: _ :: r =>
      filterArgs r
    -- delete `Hint` and `Branch` occurrence at the end of the tactic sequence.
    | Syntax.node _ `LeanBlocksGame.Tactic.Hint _ :: []
    | Syntax.node _ `LeanBlocksGame.Tactic.Branch _ :: [] =>
        []
