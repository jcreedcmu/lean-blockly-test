...
const levelDefinitions: LevelDefinition[] = [
  ...
  {
    name: "Field 𝕜",
    initial: { "blocks": { "languageVersion": 0, "blocks": [{ "type": "lemma", "id": "test-lemma", "x": 20, "y": 20, "fields": { "THEOREM_NAME": "test", "THEOREM_DECLARATION": "𝕜 = 𝕜"},  "i nputs":{"   L EMMA_PROOF":{"   b lock":{"   t ype":"t  actic_other","i  d":"t  est-tactic","f  ields":{"   P ROP_NAME":"r  fl"}}   } } } ]}}
   }
];
